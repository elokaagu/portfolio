...
def create_question(question_text, days):
    """
    Create a question with a given `question_text` and published the given number of `days` offset to now (negative
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        Questions with a pub_date in teh past are displayed on teh index page.
        """
